...
public class CarPriceEstimator {
    ...
    public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven,
        ...
        if (ageOfCar <= 10){
           // salePrice = 0.5 * salePrice * ageOfCar;
        ...
        System.out.println("Additional miles : "+additionalMiles);
...
//        double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2020, 5000.0, 2, true, true, true, false, false, false);
     //   double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2019, 5000.0, 1, true, true, true, false, false, false);
        double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2019, 5000.0, 2, false, true, true, false, false, false);
